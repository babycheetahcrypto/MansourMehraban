    ...
    <div className="flex-grow flex flex-col items-center justify-center p-4 pb-16 relative">
      <div className="text-center mb-4 w-full max-w-md">
        ...
        <div className="flex flex-col items-center justify-center w-full max-w-md mx-auto mb-16">
          <button
            className="w-[calc(100vw-8px)] max-w-[300px] aspect-square rounded-full overflow-show shadow-lg z-20 coin-button mb-6 transform transition-all duration-100 active:scale-95 hover:shadow-2xl hover:scale-105"
            onClick={clickCoin}
            onTouchStart={(e) => {
              e.preventDefault();
              clickCoin(e);
