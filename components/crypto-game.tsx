...
const CryptoGame: React.FC<CryptoGameProps> = ({ userData, onCoinsUpdate, saveUserData }) => {
  ...
  const renderSettings = () => (
    <div className="flex-grow flex items-center justify-start p-4 pb-16 relative overflow-y-auto">
      ...
      <NeonGradientCard className="bg-gradient-to-br from-gray-900/70 via-gray-800/70 to-black/70 backdrop-blur-md text-white w-full max-w-md overflow-hidden transform transition-all duration-300 hover:shadow-2xl relative z-10">
        <CardHeader className="relative">
