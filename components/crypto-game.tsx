          ...
          <div className="w-full space-y-4">
            ...
            <div className="flex space-x-4 mt-auto">
              <Button
                ...
                className="flex-1 bg-transparent backdrop-filter backdrop-blur-md border border-white/20 text-white px-4 py-2 rounded-full shadow-lg transform transition-all duration-300 hover:scale-110 hover:rotate-3 active:scale-95 active:rotate-0"
              >
                <Image
