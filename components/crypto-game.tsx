...
const CryptoGame: React.FC<CryptoGameProps> = ({ userData, onCoinsUpdate, saveUserData }) => {
  ...
  const renderHome = () => (
    <div className="flex flex-col h-full justify-between px-4 pt-2 pb-20 overflow-hidden">
      ...
      <div className="flex-grow flex items-center justify-center">
        <button
          className="w-[300px] h-[300px] rounded-full overflow-hidden shadow-lg z-20 coin-button relative bg-transparent"
          onClick={clickCoin}
