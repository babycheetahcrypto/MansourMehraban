...
.animate-button-click {
  ...
  25% {
    border-color: #ff758c; /* Peach */
  }
  50% {
    border-color: #ff7eb3; /* Back to Pink */
  }
  75% {
    border-color: #ffaf7b; /* Orange */
  }
  100% {
    border-color: #ff758c; /* Peach */
  }
...
.animate-gradient-border {
  ...
  border-image-source: linear-gradient(90deg, #ff7eb3, #ff758c, #ffaf7b, #ff758c);
    ...
    <div className="flex-grow flex items-center justify-center p-6">
      <NeonGradientCard className="bg-gradient-to-br from-gray-900 to-black text-white w-full max-w-2xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl">
        <CardHeader className="relative p-6 pb-2">
          ...
          <div className="relative w-full h-full bg-gray-900/50 rounded-2xl overflow-hidden shadow-lg">
            <div className="absolute inset-0 rounded-2xl border-4 animate-gradient-border" />
            <div className="absolute inset-0 bg-gradient-to-br from-gray-800 via-gray-900 to-black opacity-50 rounded-2xl"></div>
            <div className="absolute inset-0 mx-auto w-3/4 h-3/4 bg-gradient-radial from-transparent via-gray-800 to-gray-900 opacity-60 rounded-full blur-xl"></div>
          </div>
        </CardHeader>
