...
const CryptoGame: React.FC<CryptoGameProps> = ({ userData, onCoinsUpdate, saveUserData }) => {
        ...
        <div key={index}>
          ...
          >
            ...
            <CardContent className="flex flex-col items-center justify-center p-2">
              <div className="relative w-32 h-32 rounded-full overflow-hidden shadow-lg mb-2 coin-button levels-image">
                <Image
                  src={image}
                  alt={`Level ${index + 1}`}
                  layout="fill"
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative flex flex-col">
      ...
      <StarryBackground />
      {renderHeader()}
      <div className="flex-grow overflow-y-auto pb-20 relative">
